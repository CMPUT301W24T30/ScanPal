                        ...
                        if (eventDoc.exists()) {
                            ...
                            Log.d("GETBYEID", "Document found with ID: " + EventID);
                                ...
                                Event event = new Event(
                                    ...
                                    Objects.requireNonNull(eventDoc.get("name")).toString(),
                                    Objects.requireNonNull(eventDoc.get("description")).toString(),
                                    eventDoc.contains("imageUrl") ? Objects.requireNonNull(eventDoc.get("imageUrl")).toString() : "defaultImageUrl" // Replace "defaultImageUrl" with an actual URL or keep it as a placeholder
                                );
